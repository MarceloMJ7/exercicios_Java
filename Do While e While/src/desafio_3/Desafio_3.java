...
public class Desafio_3 {
	...
	public static void main(String[] args) {
		...
		for (String nome : nomesMenorSalario) { // lembrando que cada volta do loop a String "nome" vai conter um valor que será adicionado a lista nomesMenorSalario
	...
	public static int solicitaQtdFilhos() {
		String cFilhos;
		int filhos = 0;
